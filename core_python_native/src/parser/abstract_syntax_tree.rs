...
pub enum AbstractSyntaxNodes {
    ...
    NotIn                   ( u32, u32, Box<AbstractSyntaxNodes>, Box<Symbols>, Box<Symbols>, Box<AbstractSyntaxNodes> ),
    IsNot                   ( u32, u32, Box<AbstractSyntaxNodes>, Box<Symbols>, Box<Symbols>, Box<AbstractSyntaxNodes> ),
